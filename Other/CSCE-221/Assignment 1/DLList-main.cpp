...
int main ()
{
  ...
  DLListNode* add1 = dll2.getHeader().next;
  ...
  DLListNode* add2 = dll2.getTrailer().prev;
  ...
  DLListNode* subtract1 = dll3.getHeader().next;
  ...
  DLListNode* subtract2 = dll3.getTrailer().prev;
